...
import { whatsappLink, attendanceMessage } from '@/lib/whatsapp'
                  ...
                  <div key={student.id} className="flex items-center gap-4 px-5 py-4">
                    ...
                    {isSubmitted && !editMode ? (
                      <div className="flex items-center gap-2">
                        ...
                        {(displayStatus === 'absent' || displayStatus === 'leave') && (
                          <a
                            href={whatsappLink(
                              student.mobile,
                              attendanceMessage(
                                student.name,
                                (student as Student & { parent_name?: string }).parent_name ?? '',
                                dateStr,
                                displayStatus as 'absent' | 'leave'
                              )
                            )}
                            target="_blank" rel="noopener noreferrer"
                            title="Notify parent on WhatsApp"
                            className="flex items-center gap-1 px-2 py-1 text-xs font-medium bg-green-50 text-green-700 rounded-lg hover:bg-green-100"
                          >
