...
import { FileText, Send, CheckCircle, ChevronDown, ChevronUp, Eye, X } from 'lucide-react'
import api from '@/lib/api'
import { Student } from '@/types'
import { whatsappLink, invoiceMessage } from '@/lib/whatsapp'
                        ...
                        <div className="flex items-center justify-end gap-2">
                          ...
                          {inv.status !== 'paid' && (
                            <a
                              href={whatsappLink(
                                inv.students?.mobile,
                                invoiceMessage(inv.students?.name, inv.month, inv.amount, upiId, inv.status)
                              )}
                              target="_blank" rel="noopener noreferrer"
                              className="flex items-center gap-1.5 px-2.5 py-1 text-xs font-medium bg-green-50 text-green-700 rounded-lg hover:bg-green-100"
